...
pros::Controller Controller1(id: pros::E_CONTROLLER_MASTER);
...
void setDriveMotors(){
	int leftJoystick = Controller1.get_analog
	(channel: pros::E_CONTROLLER_ANALOG_RIGHT_Y);
	int rightJoystick = Controller1.get_analog
